...
import BackgroundImage from '@/public/Hero-section-bg.png'
import HeroLight from '@/public/hero-interface-exp.png'
import HeroDark from '@/public/image.png'
                        ...
                        <div className="mx-auto max-w-7xl px-6">
                            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                                ...
                                <TextEffect
                                    ...
                                    Lunex organizes conversationsinto channels with threads, is realtime, and uses AI to keep teams in sync.
                                </TextEffect>
